...
// Decirle a Express que vamos a usar EJS para las páginas
app.set("view engine", "ejs");
app.set("views", "./views");

// La carpeta public tiene el CSS y otros archivos estáticos
...
// Sesiones: aquí guardamos el token del usuario al iniciar sesión
